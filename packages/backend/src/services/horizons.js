 ...
 */
function buildJ2000ToTEME(epochMs) {
 ...
 */
export async function fetchHorizonsVectors(commandId, start, stop, stepMinutes = 10) {
    ...
    if (raw.length === 0)
        throw new Error('Horizons returned 0 valid ephemeris points');
